...
class UserTest < ActiveSupport::TestCase
  ...
  def setup
    @user = User.new(username: "Tibbo93", email: "alessandrotibaldi93@gmail.com", nome: "Alessandro", 
                    ...
                    data_nascita: "1993-08-25", password: "foobar93", password_confirmation: "foobar93")
  end
  ...
  test "comune should be present" do
    @user.comune = "     "
    assert_not @user.valid?
  end

  test "comune should not be too long" do
    @user.comune = "a" * 31
    assert_not @user.valid?
  end

  test "data_nascita should be present" do
    @user.data_nascita = "     "
    assert_not @user.valid?
  end
